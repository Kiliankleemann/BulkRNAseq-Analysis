...
scp -r Data/*.fq.gz kkleemann@bonna.hpc.uni-bonn.de:~/Aref_DNA_damage_Oct_2023/raw_fastq

#scripts
scp -r Cluster_computing_scripts/Run_STAR_mm10.sh kkleemann@bonna.hpc.uni-bonn.de:~/Aref_DNA_damage_Oct_2023/scripts



#Download BAM files from cluster
scp -r kkleemann@bonna.hpc.uni-bonn.de:~/Aref_DNA_damage_Oct_2023/BAM_files '/Users/kiliankleemann/sciebo - Kleemann, Kilian (kleemann@uni-bonn.de)@uni-bonn.sciebo.de/Aref_DNA_damage_Oct_2023/data/BAM_files'
